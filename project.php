...
<html lang="en">
  <head>
    <title>PROJECTS || CSC FUNAAB</title>
  ...
  <body id="top">
   <?php include_once('inc/headstyle.php'); ?>
     ...
     <?php 
		...
		echo '<a href="project.php?action=updateProject&id='. $result['id'] .'"><h3>'.$result['header'].'</h3></a>';
		}
			 ?>
              <p class="form_notice"><i>Please fill to add new  header/content</i></p>
        <form action="project.php" method="post" id="form">
            ...
            <tr><td width="60px" height="50px"><label>Header</label></td><td><input type="text" name="header" size="74px" id="header"></td></tr>
              ...
              <tr><td></td><td><input type="submit" name="submitProject" id="submit" value="Insert Project"></td></tr>
            </table>
            </form>
		<?php	}else 
	 ...
	 <form action="project.php" method="post" id="form">
            ...
            <tr><td width="60px" height="50px"><label>Header</label></td><td><input type="text" name="header" size="74px" id="header" value="<?php echo $result['header'] ?>"><input type="hidden" name="id" value="<?php echo $id ?>"/></td></tr>
              ...
              <tr><td></td><td><input type="submit" name="updateProject" id="submit" value="Update Project">
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="project.php?action=del&id=<?php echo $result['id']; ?>" id="submit">Delete</a></td></tr>
            </table>
            </form>
	<?php
    }else{
		...
		echo $result['note'];
         ...
         <?php if(isset($_SESSION['username'])){ ?>
        <div class="editSection"><a href="project.php?action=editProject">Click To Edit Projects</a></div>
        <?php } ?>
    </div><!--sel_page-->
        </div><!---section-->
        </div><!-- end main -->
